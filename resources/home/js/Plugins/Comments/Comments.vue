<template>
  <div class="card">
    ...
    <div class="load-more" v-if="comments.count > comments.data.length" @click="loadMore">
      ...
      <span>{{ trans("layout.load-more-comments") }}</span>
    </div>
    <Input @added="comments.data.unshift($event)" :use-rating="true" />
  </div>
</template>
...
const submitComment = (content: string, id: number | null = null, rating: number | null = null) => {
